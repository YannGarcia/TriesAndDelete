...
for i in `find ../include -name "*.hh" -type f`
do
    rm ./`basename $i`
done
for i in `find ../src -name "*.cc" -type f`
do
    rm ./`basename $i`
done
...
ADD_INCLUDE='/CPPFLAGS = /a\\CPPFLAGS += -I../include -I../include/ports -I../include/layers -I../include/comm -I../include/codec -I../include/loggers -I. -I$(HOME_INC)'
